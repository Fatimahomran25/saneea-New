  ...
  .onCreate(async (snap, context) => {
    ...
    const payload = {
      ...
      data: {
        type: 'chat_message',
        chatId,
        requestId: (chatData.requestId || '').toString(),
        proposalId: '',
        contractId: '',
        senderId,
        receiverId,
  ...
  .onCreate(async (snap, context) => {
    ...
    const payload = {
      ...
      data: {
        ...
        proposalId: (notificationData.proposalId || '').toString(),
        contractId: (notificationData.contractId || '').toString(),
        chatId: (notificationData.chatId || '').toString(),
